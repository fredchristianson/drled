...
#define SCRIPT_ELEMENT_LOGGER_LEVEL     DEBUG_LEVEL
#define SCRIPT_HSLSTRIP_LOGGER_LEVEL    DEBUG_LEVEL
#define SCRIPT_EXECUTOR_LOGGER_LEVEL    DEBUG_LEVEL
#define SCRIPT_LOADER_LOGGER_LEVEL      ERROR_LEVEL
#define SCRIPT_POSITIONLOGGER_LEVEL     DEBUG_LEVEL
#define SCRIPT_VALUE_LOGGER_LEVEL       DEBUG_LEVEL
#define STRIP_ELEMENT_LOGGER_LEVEL      DEBUG_LEVEL
#define SHARED_PTR_LOGGER_LEVEL         WARN_LEVEL  
#define TEST_LOGGER_LEVEL               WARN_LEVEL
