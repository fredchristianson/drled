...
#define CONFIG_LOGGER_LEVEL          DEBUG_LEVEL
#define COMPOUND_STRIP_LOGGER_LEVEL DEBUG_LEVEL
...
#define JSON_LOGGER_LEVEL      ERROR_LEVEL
...
#define SCRIPT_LOGGER_LEVEL       ERROR_LEVEL
#define SCRIPT_EXECUTOR_LOGGER_LEVEL    ERROR_LEVEL
#define SCRIPT_LOADER_LOGGER_LEVEL      ERROR_LEVEL
